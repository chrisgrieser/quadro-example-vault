...
var formatString = (tmpl, val) => formatStrings(tmpl, [{ s: val }])[0];
...
var createFilePath = async (vault, title, path = DEFAULT_PATH) => {
...
var FrontMatterProp = class {
  constructor(s, d) {
    ...
    var _a;
    if (!d && !s)
      throw Error("FrontMatterItem objects require either a setting or a default");
...
var DEFAULT_PATH = "Slurped Pages";
...
var SlurpPlugin = class extends import_obsidian6.Plugin {
  ...
  fixTagPrefix(tagPrefix) {
    return tagPrefix.endsWith("/") ? tagPrefix.substring(0, tagPrefix.length - 1) : tagPrefix;
  }
